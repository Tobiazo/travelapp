...
export default function Destinasjonsboks({id, land, tittel, beskrivelse, rating, imgPath}) {
      ...
      <div>
        <div id='destinasjonsBildeDiv'>
            <a href={'/destinations/' + id}>
              ...
              <img class='destinasjonsBilde' src={`http://localhost:4000/images/${imgPath}`} alt='Her er ett bilde av pariestårnet'/>
            </a>
